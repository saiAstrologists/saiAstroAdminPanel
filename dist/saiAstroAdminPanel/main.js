...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 5, vars: 9, consts: [[1, "header-wrapper", 3, "ngClass"], [1, "container-fluid"], ["class", "clearfix", 4, "ngIf"], ["class", "drawer-menu", 4, "ngIf"], [1, "backdrop", 3, "ngClass", "click"], [1, "clearfix"], [1, "float-left"], [1, "logo-ham-sec"], [1, "hamburger"], ["mat-icon-button", "", 1, "example-icon", 3, "click"], [1, "logo"], ["src", "../admin/assets/imgs/sai-logo.png", "alt", "Sai Astro", "width", "180px", 1, "img-fluid"], [1, "float-right"], [1, "user-profile"], [1, "dropdown", "mt-1"], ["type", "button", "id", "dropdownMenuButton", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "btn-secondary", "dropdown-toggle"], ["aria-labelledby", "dropdownMenuButton", 1, "dropdown-menu", "dropdown-menu-right"], [1, "dropdown-item", 3, "click"], [1, "drawer-menu"], [1, "side-bar-logo"], ["src", "admin/assets/imgs/sai-logo.png", "width", "150px", 1, "img-fluid"], ["mat-icon-button", "", 1, "close-btn", 3, "click"], [3, "click"], [3, "click", 4, "ngIf"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
